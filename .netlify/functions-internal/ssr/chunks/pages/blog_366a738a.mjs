import { e as createAstro, f as createComponent, r as renderTemplate, m as maybeRenderHead, g as renderSlot, h as addAttribute, i as renderComponent, j as renderHead } from '../astro_e3fc0b0e.mjs';
import 'clsx';
...
const $$Blog = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Blog;
  const posts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./post/post-01.md": () => import('./post-01_eb50424d.mjs'),"./post/post-02.md": () => import('./post-02_27656fae.mjs')}), () => "./post/*.md");
